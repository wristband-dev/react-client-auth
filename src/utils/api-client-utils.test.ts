...
describe('getCsrfToken', () => {
  ...
  it('should return null when no cookies exist', () => {
    ...
    const result = getCsrfToken('XSRF-TOKEN');
  ...
  it('should extract the token when multiple cookies exist', () => {
    ...
    document.cookie = 'XSRF-TOKEN=multi-cookie-token; path=/;';
  ...
  it('should handle cookies with special characters', () => {
    ...
    document.cookie = 'XSRF-TOKEN=complex%20token%26with%3Dspecial%20chars; path=/;';
  ...
  it('should extract the token when the cookie is at the start of the string', () => {
    ...
    document.cookie = 'XSRF-TOKEN=first-position; path=/;';
  ...
  it('should extract the token when the cookie is in the middle of the string', () => {
    ...
    document.cookie = 'first-cookie=first-value; path=/;';
    document.cookie = 'XSRF-TOKEN=middle-position; path=/;';
    document.cookie = 'last-cookie=last-value; path=/;';
  ...
  it('should extract the token when the cookie is at the end of the string', () => {
    ...
    document.cookie = 'first-cookie=first-value; path=/;';
    document.cookie = 'XSRF-TOKEN=last-position; path=/;';
  ...
  it('should handle cookies with spaces in the cookie string', () => {
    ...
    document.cookie = 'XSRF-TOKEN=space-token;';
  ...
  it('should return the correct value for different cookie names', () => {
    ...
    expect(getCsrfToken('XSRF-TOKEN')).toBe('xsrf-value');
  ...
  it('should be case-sensitive for cookie names', () => {
    ...
    document.cookie = 'XSRF-TOKEN=uppercase-value; path=/;';
    document.cookie = 'xsrf-token=lowercase-value; path=/;';

    expect(getCsrfToken('XSRF-TOKEN')).toBe('uppercase-value');
    expect(getCsrfToken('xsrf-token')).toBe('lowercase-value');
    // Should not find mixed case that doesn't exist
    expect(getCsrfToken('Xsrf-Token')).toBeNull();
  });
});
